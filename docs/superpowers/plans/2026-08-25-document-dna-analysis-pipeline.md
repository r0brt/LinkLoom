...
- [ ] **Step 1: Add failing literal tests for begin and exact failed transition**
...
- [ ] **Step 3: Implement the minimum exact begin transaction**
...
- [ ] **Step 4: Implement the minimum exact failed transaction and verify GREEN**
...
- [ ] **Step 5: Add stale and superseded RED regressions**
...
- [ ] **Step 6: Run stale regressions RED, tighten guards, and verify GREEN**
...
- [ ] **Step 7: Commit guarded attempt transitions**
...
- [ ] **Step 2: Run restoration test RED**
...
- [ ] **Step 3: Implement exact idempotent restoration and verify GREEN**
...
- [ ] **Step 4: Write failing source recovery and retry tests**
...
- [ ] **Step 7: Commit recovery and retry behavior**
...
- [ ] **Step 1: Create the real in-memory pipeline fixture and first failing test**
...
- [ ] **Step 2: Run the first pipeline test RED**
...
- [ ] **Step 3: Implement public values and the minimum sequential pipeline GREEN**
...
- [ ] **Step 4: Add same-version, target-version, and zero-limit tests RED**
...
- [ ] **Step 5: Run version/limit tests RED and implement only missing behavior GREEN**
...
- [ ] **Step 6: Add bounded-concurrency test RED**
...
- [ ] **Step 7: Replace sequential batch work with a bounded task group GREEN**
...
- [ ] **Step 8: Commit happy-path pipeline**
...
- [ ] **Step 1: Write failing deterministic document-failure isolation tests**
...
- [ ] **Step 2: Run failure tests RED, implement mapping, verify GREEN**
...
- [ ] **Step 3: Add pending-query and partial-report RED tests**
...
- [ ] **Step 4: Run typed-error tests RED, implement stable mapping and priority GREEN**
...
- [ ] **Step 5: Add stale-during-analysis RED tests**
...
- [ ] **Step 6: Run stale tests RED, preserve repository stale classification GREEN**
...
- [ ] **Step 7: Add cancellation restoration RED tests**
...
- [ ] **Step 8: Run cancellation tests RED, add exact unstructured cleanup GREEN**
...
- [ ] **Step 9: Commit failure and cancellation reliability**
...
- [ ] **Step 1: Add overlapping same-source instance RED test**
...
- [ ] **Step 2: Run same-source test RED and add shared coordinator GREEN**
...
- [ ] **Step 3: Add different-source concurrency and cancelled-waiter RED tests**
...
- [ ] **Step 4: Run coordinator edge tests RED, finish FIFO cancellation GREEN**
...
- [ ] **Step 5: Add run-start recovery and manual retry pipeline tests RED**
...
- [ ] **Step 6: Invoke recovery before first query and verify retry GREEN**
...
- [ ] **Step 7: Add real local analyzer integration test RED**
...
- [ ] **Step 8: Run integration RED, adjust only fixture literals, verify GREEN**
...
- [ ] **Step 9: Commit coordination and integration**
...
- [ ] **Step 1: Run focused repository and pipeline suites**
